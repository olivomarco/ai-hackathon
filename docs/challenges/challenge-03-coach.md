---
title: "Challenge 03 Coach Notes: Prompt Flow"
parent: Challenges
nav_order: 103
nav_exclude: true
...
<div class="hero-panel challenge-hero">
  <span class="hero-kicker">Challenge 03 • Coach Notes</span>
  <h1>Prompt Flow: Coach View</h1>
...
<nav class="page-nav">
  ...
  <a href="{{ '/challenges/challenge-03' | relative_url }}">Student page →</a>
</nav>
