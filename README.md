...
[![GitHub Pages](https://github.com/microsoft/ai-hackathon/actions/workflows/pages.yml/badge.svg)](https://github.com/microsoft/ai-hackathon)
...
**What The Hack** (WTH) is Microsoft's hackathon-in-a-box format designed to teach cloud and AI technologies through hands-on challenge-based learning. This repository brings WTH to Azure AI Foundry, a unified platform for building, evaluating, and deploying intelligent applications.

In this hackathon, you and your team will work through seven progressive challenges over a single day (6–8 hours). Rather than lectures, you'll learn by *doing*: deploying models, engineering prompts, building AI workflows, and shipping a real AI-powered application. Coaches are on hand to guide discovery, unblock issues, and help you think through design decisions—but the learning is yours to own.

By the end, you'll have hands-on experience with the Azure AI Foundry platform, practical skills in prompt engineering and RAG (Retrieval-Augmented Generation), and a deployment-ready AI application to show for your work.
...
- Navigate Azure AI Foundry and create an AI project with connected resources
...
- Are familiar with Azure AI Foundry, Azure OpenAI Service, and prompt engineering
...
Follow the prompts to sign in with your Azure account. This connects your workspace to your Azure subscription so you can provision Azure AI Foundry resources.

### 3. Start with Challenge 00

Read [Challenge 00: Setup & Orientation](challenges/challenge-00-setup/README.md) to begin. This 30-minute challenge will verify your environment and get you familiar with the Azure AI Foundry interface.
...
|---|-----------|----------|------------|------------|
| 00 | [Setup & Orientation](challenges/challenge-00-setup/README.md) | 30 min | ⭐ | Azure AI Foundry, Hub/Project |
...
- **[Azure AI Foundry Documentation](https://learn.microsoft.com/azure/ai-foundry/)** — Official docs and tutorials
...
**Ready to build?** Start with [Challenge 00](challenges/challenge-00-setup/README.md) now. 🚀
